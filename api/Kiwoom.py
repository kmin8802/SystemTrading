...
class Kiwoom(QAxWidget):
    ...
    def _set_signal_slots(self):
        ...
        #조회에 대한 응담슬롯
        self.OnReceiveTrData.connect(self._on_recieve_tr_data)
    ...
    def _on_recieve_tr_data(self, screen_no, rqname, trcode, record_name, next, unused1, unused2, unused3, unused4):
        print("[Kiwoom] _on_recieve_tr_data is called {} / {} / {}".format(screen_no, rqname, trcode))
        ...
        # 예수금정보 조회
            ...
            print(self.tr_data)
        # 체결 요청 조회 (최근 주문 한건만 저장가능 DB활용하여 수정필요)
